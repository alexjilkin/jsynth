...
const Delay = ({ }) => {
    ...
    return (
        <div styleName="container">
            ...
            <div styleName="knobs">
                <div styleName="knob">
                    <Knob width={120} height={120} title="Time" value={time} onChange={setTime} max={3} min={0.1} color={0x66ff66} />
                </div>

                <div styleName="knob">
                    <Knob width={120} height={120} title="Depth" value={depth} onChange={(v) => setDepth(Math.round(v))} max={6} min={1} color={0x77ff77} />
                </div>

                <div styleName="knob">
                    <Knob width={120} height={120} title="Gain" value={gain} onChange={setGain} max={0.8} min={0.2} color={0x66ff66} />
                </div>
